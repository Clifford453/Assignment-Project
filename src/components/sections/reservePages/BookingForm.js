...
export default function ReservationsForm(props){
    ...
    const[finalTime, setFinalTime] = useState(
        props.avilableTimes.map((times) => <option>{times}</option>)
    );
    ...
    function handleDateChange(e) {
        ...
        setFinalTime(props.avilableTimes.map((times) => <option>{times}</option>));
    }
    ...
    return(
        <form className="reservation-form">
            ...
            <br></br>
                <small>
                    <p>
                        Note: You cannot edit your reservation after submissions. Please 
                        double-check your reservation before submitting your reservation request,
                    </p>
                </small>
